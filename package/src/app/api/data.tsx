...
export const portfolioData: { title: string; description: string }[] = [
  {
    title: "Self-custody portfolio hub",
    description:
      "Unified balances and performance across exchanges, on-chain wallets, and custodians.",
  },
  {
    title: "Institutional treasury views",
    description:
      "Multi-entity reporting, governance workflows, and sign-off trails that satisfy stakeholders.",
  },
  {
    title: "Developer-friendly APIs",
    description:
      "Clean, well-documented endpoints so your team can ship portfolio experiences quickly.",
  },
];
