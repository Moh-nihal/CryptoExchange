      ...
      <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
        ...
        <div className='mt-5'>
          <p className='text-base font-medium text-muted/60'>
            NovaLedger is built with modern Next.js, React and Tailwind CSS.
          </p>
          <p className='text-base font-medium text-muted/60'>
            The codebase is structured so you can extend or swap modules
            depending on your product needs.
          </p>
          <p className='text-base font-medium text-muted/60'>
            For deeper customization you should be comfortable with Next.js,
